...
def busqueda_codigo(parent):
    ...
    parent.btn_busqueda_descripcion = tb.Button(master = lblframe_busqueda_detalle_venta, text = ' # ', 
    ...
    parent.ent_buscar_detalle_venta = tb.Entry(master = lblframe_busqueda_detalle_venta, width = 100, 
                                               bootstyle = 'info')
