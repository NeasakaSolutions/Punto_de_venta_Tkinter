...
def ventana_modificar_usuario(parent):
    ...
    from logica.logica_usuarios.llenar_entrys import llenar_entrys_modificar_usuario
    from logica.logica_usuarios.modificar_usuario import modificar_usuario
    from logica.logica_usuarios.centrar_ventana_modificar_usuario import centrar_ventana_modificar_usuario
